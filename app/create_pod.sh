...
podman run -d --pod descentinel --name identify_game_scene -e RUST_LOG=info -e RABBITMQ_AMQP_URL=0.0.0.0 identify_game_scene_service
podman run -d --pod descentinel --name detect_card -e RUST_LOG=info -e RABBITMQ_AMQP_URL=0.0.0.0 detect_card_service
